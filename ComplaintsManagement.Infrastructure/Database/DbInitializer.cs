...
namespace ComplaintsManagement.Infrastructure.Database
{
    public class DBInitializer : DropCreateDatabaseAlways<ComplaintsDbContext>
    {
        ...
        //    IList<Costumers> defaultUsers = new List<Costumers>();
        //    defaultUsers.Add(new Costumers { Name = "Nelson", LastName = "Veras", Email = "nveras@complaints.com", Password = "@Hola1234", DocumentNumber="12345465432" });
        //    defaultUsers.Add(new Costumers { Name = "Jose", LastName = "Perez", Email = "jperez@complaints.com", Password = "@Hola1234", DocumentNumber = "34324123123" });
        //    defaultUsers.Add(new Costumers { Name = "Juan", LastName = "Perez", Email = "juanperez@gmail.com", Password = "@Hola1234", DocumentNumber = "40208743738" });
